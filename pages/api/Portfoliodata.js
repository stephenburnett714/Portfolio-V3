...
export const PortfolioData = [
    ...
    },
    {
      ...
      description: "Created a website for Azizi Kids. Was contracted to create a site based on the clients original site and make it responsive. For this website I used NextJS as a new tool. Used paypal as a way for customers to purchase books through the website.",
    },
    {
      id: 4,
      title: "Hummingbird Telecom Solutions",
      liveSite: "https://hummingbirdtelecom.net/",
      image:"/Hummingbird.jpg",
      gitHub: "https://github.com/stephenburnett714/Soromma",
      description: "Created a website for Hummingbird Telecom Solutions using React. Was contracted to make a one-page website after the delivery of a wire-frame to the CEO. For this website I decide to use syled-components as a new tool.",
    },
    {
      id: 3,
      ...
      description: "Created a restaurant application using React(Front-End), Ruby on Rails(Back-End). The application is comprised of a home, event, delivery, menu and profile screens. The user has the ability to make and order which is put into the backend. The application allows the user to order food and each of the orders are put to the backend.",
    },
    {
      id: 2,
